...
<body>
    ...
    <div class="container">
        <section class="main-content">
            <h2>Welcome to Huy's Coursework Forum Discussion</h2>
            <p>This website is a place for all students to ask and answer questions related to coursework!</p>
            <img src="/images/welcomeimage.png" alt="Example Image" class="main-image">
        </section>
